...
router.get("/book/:id", user, book.getDetail);
...
router.get("/author/:id", user, author.getDetail);
...
router.get("/genre/:id", user, genre.getDetail);
...
router.get("/bookinstance/:id", user, bookinstance.getDetail);
